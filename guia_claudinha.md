...
- **Não verificado ao vivo** (nenhum prestador seedado tem conta vinculada pra logar de verdade, ver §11 homologação de 2026-08-30) — só build+lint, sem screenshot da tela renderizada. Se aparecer algo estranho visualmente, é o primeiro lugar a olhar.
